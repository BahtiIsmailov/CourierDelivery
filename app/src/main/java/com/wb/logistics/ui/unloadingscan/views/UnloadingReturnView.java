...
public class UnloadingReturnView extends FrameLayout {
    ...
    private final static int DEFAULT_CURRENT_STATE = com.wb.logistics.ui.unloadingscan.views.UnloadingReturnMode.EMPTY;
    ...
    private void initState() {
        switch (currentState) {
            case com.wb.logistics.ui.unloadingscan.views.UnloadingReturnMode.EMPTY:
                emptyState();
                break;
