...
import ru.wb.perevozka.databinding.DcLoadingHandleFragmentBinding
...
class DcLoadingHandleFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        dialog?.setOnShowListener {
            ...
            val bottomSheetInternal =
                bottomSheetDialog.findViewById<View>(ru.wb.perevozka.R.id.design_bottom_sheet)
    ...
    override fun getTheme(): Int {
        return ru.wb.perevozka.R.style.HandleInputBottomSheetDialog
    }
