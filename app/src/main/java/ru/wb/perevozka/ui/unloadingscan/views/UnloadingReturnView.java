package ru.wb.perevozka.ui.unloadingscan.views;
...
public class UnloadingReturnView extends FrameLayout {
    ...
    private final static int DEFAULT_CURRENT_STATE = ru.wb.perevozka.ui.unloadingscan.views.UnloadingReturnMode.EMPTY;
    ...
    private void initState() {
        switch (currentState) {
            case ru.wb.perevozka.ui.unloadingscan.views.UnloadingReturnMode.EMPTY:
                emptyState();
                break;
