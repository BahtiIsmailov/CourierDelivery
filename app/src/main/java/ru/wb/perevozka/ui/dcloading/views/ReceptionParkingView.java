package ru.wb.perevozka.ui.dcloading.views;
...
public class ReceptionParkingView extends FrameLayout {
    ...
    private void initView() {
        ...
        View layoutView = inflater.inflate(R.layout.dc_loading_parking, this, false);
    ...
    private void initDefaultState() {
        parkingNumber = getResources().getString(R.string.dc_loading_default_parking);
