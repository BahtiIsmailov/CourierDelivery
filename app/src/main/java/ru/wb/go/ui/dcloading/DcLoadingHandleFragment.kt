...
import ru.wb.go.databinding.DcLoadingHandleFragmentBinding
...
class DcLoadingHandleFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        dialog?.setOnShowListener {
            ...
            val bottomSheetInternal =
                bottomSheetDialog.findViewById<View>(ru.wb.go.R.id.design_bottom_sheet)
    ...
    override fun getTheme(): Int {
        return ru.wb.go.R.style.HandleInputBottomSheetDialog
    }
